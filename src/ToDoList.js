...
const TodoList = () => {
    ...
    return (
        <div className="container">
            ...
            <button className="btn btn-outline-primary my-3" onClick={handleAddTodo}>Save</button>

            <ul className="list-group mt-3">
                {todos.map((todo, index) => (
                    <li 
                        className="list-group-item d-flex justify-content-between align-items-center" key={index}>
                        {todo}
